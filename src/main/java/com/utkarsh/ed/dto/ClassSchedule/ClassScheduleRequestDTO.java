...
public record ClassScheduleRequestDTO(
        ...
        @Schema(description = "Google Meet or Zoom link for the session", example = "https://meet.google.com/abc-defg-hij")
        @NotBlank(message = "Meeting link cannot be empty") @URL(message = "Meeting link must be a valid URL")
                String meetLink) {
