...
public record StudentRequestDTO(
        @Schema(description = "Student's full name", example = "Aryan Sharma") @NotBlank(message = "Name is required")
                String name,
        ...
        @Schema(description = "Parent's phone number (Australian format preferred)", example = "+61412345678")
                String parentPhone,
        @Schema(description = "Father's name", example = "Rajesh Sharma") String fatherName,
        @Schema(description = "Mother's name", example = "Priya Sharma") String motherName,
