...
public class ClassSession extends BaseEntity{
    ...
    public ClassSession(ClassSchedule classSchedule, Teacher teacher, LocalDateTime scheduledAt, LocalDateTime actualStartAt, LocalDateTime actualEndAt, SessionStatus status, String feedbackText, String cancellationReason, boolean isTest, Double testScore) {
